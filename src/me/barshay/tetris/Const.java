...
public class Const {
	...
	ROWS_OFFSET = 3, // сдвиг дл€ стартового отображени€ фигуры над игровым полем
	NUM_OF_PIXELS = 32,
	...
	Q_WIDTH = 2.0f/COLUMNS_NUM, // ширина одной €чейки в координатах GL 
	Q_HEIGHT = Q_WIDTH * (float)(FIELD_WIDTH / (float)FIELD_HEIGHT) // высота одной €чейки
	;
